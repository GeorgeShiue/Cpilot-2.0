...
from tool import SearchExecutionTool, WebExecutionTool, read_agent_parameter_yaml
...
class AgentFactory():
    ...
    def create_react_agent_with_yaml(agent_name, tool_dicts=None, response_format=None):
        ...
        if tool_dicts is None:
            ...
            tool_dicts = {**search_execution_tool.tool_dict, **web_execution_tool.tool_dict}  # merge all tool dicts
